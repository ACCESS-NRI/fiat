...
!Routine is a modified version of DR_HOOK_DEFAULT.
!Allows communicator to be specified. Added functionality
!as part of a separate routine to avoid the overhead of
!run-time optional argument handling.
SUBROUTINE DR_HOOK_DEFAULT_COMM(CDNAME,KSWITCH,PKEY,LCOMM,COMM)
...
CALL DR_HOOK_UTIL(LHOOK,CDNAME,KSWITCH,PKEY,'',0_JPIM)
END SUBROUTINE DR_HOOK_DEFAULT_COMM
